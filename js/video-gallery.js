...
$(document).ready(function() {
	...
	$('a.videoLink').each(function(){
		...
		var thumbnailFilePath = '../img/' + $(this).attr('videofile') + '.jpg';
	...
	$('.videoLink').click(function(){
		...
		if(testForAndroid) {
			$('#videoPlayer source[type*="../media/mp4"]').removeAttr('type');
