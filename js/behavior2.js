$(document).ready(function() {
	...
	$('a.painting-nav').click(function() {
		$('html, body').animate({ scrollTop:$('#painting').offset().top }, 1000,
			function() {
				parallax();
			});
		return false;
	});
	$('a.photography-nav').click(function() {
		$('html, body').animate({ scrollTop:$('#photography').offset().top }, 1000,
			function() {
				parallax();
			});
		return false;
